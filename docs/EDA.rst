...
I clusters e la lista di keywords al loro interno è salvato nal file new_cluster_content.json nella cartella data_new/processed. Un file di default è salvato nella cartella data/processed. 
